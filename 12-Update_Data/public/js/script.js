...
$(function() {
    ...
    $('.tombolTambahData').on('click', function() {
        ...
        $('.modal-content form').attr('action', 'http://localhost/phpmvc/12-Update_Data/public/mahasiswa/tambah');
    ...
    $('.tampilModalUbah').on('click', function() {
        ...
        // Mengubah attribute action di form yg berada di class modal-content
        $('.modal-content form').attr('action', 'http://localhost/phpmvc/12-Update_Data/public/mahasiswa/ubah');
        ...
        $.ajax({
            ...
            url: 'http://localhost/phpmvc/12-Update_Data/public/mahasiswa/getUbah',     // Method getUbah berfungsi untuk mereturn data mahasiswa sesuai dengan id yg dikirimkan
